...
module.exports.validateAddressInputs = (data) => {
  ...
  data.is_primary_address =
    data.is_primary_address === undefined ? null : data.is_primary_address;
  ...
  if (
    ...
    country.length === 0 ||
    country.length > 30 ||
    (is_primary_address !== undefined &&
      is_primary_address !== null &&
...
module.exports.validatePaymentInputs = (data) => {
  ...
  data.is_primary_payment =
    data.is_primary_payment === undefined ? null : data.is_primary_payment;
  ...
  if (
    ...
    (is_primary_payment !== undefined &&
      is_primary_payment !== null &&
      typeof is_primary_payment !== "boolean") ||
    (card_type !== undefined &&
      card_type !== null &&
      (typeof card_type !== "string" ||
        !(card_type === "credit" || card_type === "debit")))
  ) {
